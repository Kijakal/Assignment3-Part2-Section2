<template>
    <div class="container-fluid">
        ...
        <div class="d-md-none" id="collapsable-card" style="width: 80%">
            ...
            <div class="card" v-for="stock in stock" v-bind:key="stock">
                ...
                <div :id="'collapse' + stock.pk" class="collapse" :aria-labelledby="'heading' + stock.pk"
                    ...
                    <div class="card-body">
                        ...
                        <p><b>Purchased Price:</b> {{ stock.purchase_price }}</p>
                        <p><b>Purchased:</b> {{ stock.purchased }}</p>
                        <div class="btn-group">
        ...
        <div class="col col-12 col-md-10 d-none d-xl-block d-lg-block d-md-block">
            <table class="table table-hover" style="overflow-y: auto"
                ...
                <tbody>
                <tr v-for="stock in stock" v-bind:key="stock">
    ...
    export default {
        ...
        data: () => ({
            ...
            headers: [
                ...
                {text: 'Purchased', sortable: false, align: 'left',},
            ...
            getStock() {
                apiService.getStockList().then(response => {
                    ...
                    if (localStorage.getItem("isAuthenticated")
                        ...
                        this.validUserName = localStorage.getItem("log_user");
                    }
                }).catch(error => {
